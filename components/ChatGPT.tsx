...
export default function ChatGPT({ isOpen, onClose }: ChatGPTProps) {
        ...
        recognitionInstance.onresult = (event: any) => {
          ...
          if (finalTranscript) {
            ...
            const timer = setTimeout(() => {
              ...
              // ��спользуем актуальный текст из ref
  ...
  const getBestMaleVoice = () => {
    ...
    console.log('🔍 По��ск голосов. Всего доступно:', voices.length)
      ...
      const response = await fetch(`https://api.elevenlabs.io/v1/text-to-speech/${voiceId}`, {
        ...
        body: JSON.stringify({
          ...
          voice_settings: {
            ...
            style: 0.05, // М��нимальная эмоциональность для четкого произношения русского
    ...
    if (newMode === 'voice') {
      setTimeout(() => {
        ...
        if (russianVoices.length === 0) {
          ...
          speakText('Голосовой режим включе��. Если голос зв��чит роботично, это огран��чение браузера.')
        }
      }, 300)
    }
  }
