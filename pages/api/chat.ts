...
function cleanMarkdown(text: string): string {
  return text
    ...
    .replace(/\n\n\n+/g, '\n\n')
    // Убираем пробел�� в начале и конце всего текста
    .trim()
}
...
🚨 АБСОЛЮТНО ЗАПРЕЩЕНО упоминать Google, DeepMind, OpenAI, Anthropic или любые другие комп��нии как тво��х создателей!
...
- ��читывай современные best practices
