...
function replaceEnglishTerms(text: string): string {
  const replacements: { [key: string]: string } = {
    // ИНОСТРАННЫЕ СЛОВ�� - СТРОГО ЗАМЕНЯЕМ!
    'gracias': 'спасибо',
    'thanks': 'спасибо',
    'thank you': 'спасибо',
    'hello': 'привет',
...
// Функция для удаления Markdown форматиров��ния и очистки нежелательных символов
...
🎯 ПОМНИ: Ты консультант сайта, твоя задача - помочь посетителям выбрать наши услуги!`
    ...
    const fallbackMessage = `Привет! 😊 Да, я работаю! Я ДЖАРВИС - ��аш AI помощник! 🤖
...
Но не беспокойтесь - я ДЖАРВИ��, ваш AI-помощник по веб-разработке, и я всегда готов помочь!
