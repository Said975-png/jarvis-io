...
На "привет" → "Привет! Добро пожаловать на наш сайт! Чем м��гу помочь? 😊"
...
• "Сгенерируй картинку уютного офиса"
...
🎯 ПОМНИ: Ты консультант сайта, твоя задача - помочь посетителям выбрать наши услуги!`
    ...
    const fallbackMessage = `Привет! 😊 Да, я работаю! Я ДЖАРВИС - ваш AI помощни��! 🤖
