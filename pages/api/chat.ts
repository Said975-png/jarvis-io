...
// Хранилище лимито�� в памяти (в production лучше использовать Redis)
...
export default async function handler(
  ...
  // Лимиты отключены - ДЖАРВИС работает без огра��ичений
...
🎨 Но не переживайте! Мы можем с��здать для вас:
...
Мы создаем качественные сайты и веб-приложения - расскажем о наших возможностях! 💼`
    ...
    const systemMessage: ChatMessage = {
      role: 'system',
      content: `Ты ДЖАРВИС - консультант с��йта Jarvis Intercoma, который помогает посетителям.
...
- Твоя цель - помочь посетителю и показать наши преи��ущества
...
• Мобильная версия
• Базовый функционал
• Идеально для: визиток, порт��олио, небольшого бизнеса
...
✅ ПРАВИЛЬНЫЕ ОТВЕТЫ ✅
ВОПРОС: "кто тебя создал", "кто твой с��здатель", "кто разработал тебя"
...
• "Отличная идея! Г��нериру�� изображение... ✨"
