...
// Хранилище лимитов в памя��и (в production лучше использовать Redis)
...
export default async function handler(
  ...
  // Л��миты отключены - ДЖАРВИС работает без ограничений
...
- Если пользовате��ь пишет на другом языке - отвечай на русском
